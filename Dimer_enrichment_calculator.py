            ...
            for i, line in enumerate(readfile):
                ...
                if i == 0:
                    ...
                    try:
                        ...
                        Fold_change = Target_percent_mon[-1]/(Bg_percent_mon[0]+0.01)
                        print('\tDivide by zero occurred on ', dimers,',',site,'.')
                        notes.append(str('Divide by zero occurred on '+ dimers+ ','+ site+ '.'))
